...
import EditorGuidelinesComponent from "@/Components/Guidelines/organisam/EditorGuidelinesComponent";
import AssociateEditorGuidelinesComponent from "@/Components/Guidelines/organisam/AssociateEditorGuidelinesComponent";

const AssociateEditorGuidelines = () => {
                    ...
                    <div className="row pt-3 px-3 mt-md-2">
                        <div className="col-lg-9 col-md-8">
                            {selectedGuidelines ? (
                                ...
                                <AssociateEditorGuidelinesComponent />
                            )}
                        </div>
...
export default AssociateEditorGuidelines;
