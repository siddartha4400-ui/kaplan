...
import ManuscriptSubmissionGuidelines from "@/Components/Guidelines/organisam/sidebar/ManuscriptSubmissionGuidelines";

const ManuscriptSubmission = () => {
    const [selectedGuidelines, setSelectedGuidelines] = useState(1);
                    ...
                    <div className="row pt-3 px-3 mt-md-2">
                        <div className="col-lg-9 col-md-8">
                            {selectedGuidelines ? (
                                ...
                                <ManuscriptSubmissionGuidelines />
                            )}
                        </div>
