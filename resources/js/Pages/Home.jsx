...
import { getArticles } from "../services/api/apis";
...
const Home = () => {
    ...
    const [dummyArticles, setDummyArticels] = useState([
        {
            id: 1,
            articletype: "Opinion",
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const articlesResponse = await getArticles("dashboard");
                setDummyArticels(articlesResponse);
            } catch (error) {
        ...
        <div className="handheld-toolbar-enabled">
            ...
            <main className="page-wrapper model-index-less">
                ...
                <section
                    ...
                    style={{ backgroundColor: "#f6f9fc !important" }}
                >
