...
const ClinicalImageGuidelines = () => {
    return (
        <section className="container clinical-image pt-4 px-3 px-md-5">
            <h3 className="fw-semibold mb-3">Clinical Image</h3>
            ...
            <p><strong>Type of Article:</strong> Clinical Image</p>
            ...
            <p><strong>Clinical Image:</strong> The text should not exceed 450 words and should include no more than five references.</p>
...
export default ClinicalImageGuidelines;
