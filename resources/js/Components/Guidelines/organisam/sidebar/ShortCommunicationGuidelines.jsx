...
const ShortCommunicationGuidelines = () => {
    return (
        <section className="container short-communication pt-4 px-3 px-md-5">
            <h3 className="fw-semibold mb-3">Short Communication</h3>
            ...
            <p><strong>Type of Article:</strong> Short Communication</p>
            ...
            <p><strong>Word Limit/Count:</strong> The text should not exceed 2500 words and should include no more than 5 figures and/or tables.</p>
            ...
            <p><strong>Equations:</strong> Equations should be written in MathType and clearly visible.</p>
...
export default ShortCommunicationGuidelines;
