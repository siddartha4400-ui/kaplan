...
const CaseReportGuidelines = () => {
    return (
        <section className="container case-report pt-4 px-3 px-md-5">
            <h3 className="fw-semibold mb-3">Case Report</h3>
            ...
            <p><strong>Type of Article:</strong> Case Report</p>
            ...
            <p>References in the text should be in square brackets, e.g. [1,2,3], for multiple references e.g., [1, 2–5] and figures/tables are in parenthesis, e.g. (Figure 1) or (Table 1)]</p>
...
export default CaseReportGuidelines;
