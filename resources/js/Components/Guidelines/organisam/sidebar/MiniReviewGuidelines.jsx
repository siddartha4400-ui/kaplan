...
const MiniReviewGuidelines = () => {
    return (
        <section className="container mini-review-guidelines pt-4 px-3 px-md-5">
            <h3 className="fw-semibold mb-3">Mini Review</h3>
            ...
            <p><strong>Type of Article:</strong> Mini Review</p>
            ...
            <p className="fw-bold mt-3">Side Headings / Sub Headings:</p>
            <p>[Type or copy/paste your text here] [6–8]</p>

            <p className="fw-bold mt-3">Discussion:</p>
            <p>[Please enter your text here or paste the text] [9–12]</p>
            ...
            <p>References in the text should be in square brackets, e.g., [1,2,3]. For multiple references, use [1, 2–5]. Figures and tables are cited in parentheses, e.g., (Figure 1) or (Table 1).</p>
            ...
            <p>Author(s). Title of article. <em>Journal short name.</em> Year; Volume (issue): Full inclusive page numbers.</p>

            <p><strong>For a book:</strong></p>
            <p>Author(s). <em>Title of the Book.</em> (Edition). Publisher Name, Place, City, Country, (Year); pp. Full Inclusive Page Numbers.</p>

            <p><strong>For a chapter in a book:</strong></p>
            <p>Author(s). Chapter/Topic Name. In: Author(s) (Editors.), <em>Book Name.</em> (Edition). Publisher Name, Place, City, Country, (Year); pp. Full Inclusive Page Numbers.</p>

            <p><strong>For a conference paper:</strong></p>
            <p>Author(s). Conference Topic. <em>Name of the Conference</em>, Country, (Year).</p>
...
export default MiniReviewGuidelines;
