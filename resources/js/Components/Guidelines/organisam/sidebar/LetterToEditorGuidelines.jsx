...
const LetterToEditorGuidelines = () => {
    return (
        <section className="container letter-to-editor-guidelines pt-4 px-3 px-md-5">
            <h3 className="fw-semibold mb-3">Letter to Editor</h3>
            ...
            <p>
                <strong>Type of Article:</strong> Letter to Editor
            </p>
            <p>
            ...
            <h5 className="fw-semibold mt-4">References</h5>
            <p>
...
export default LetterToEditorGuidelines;
