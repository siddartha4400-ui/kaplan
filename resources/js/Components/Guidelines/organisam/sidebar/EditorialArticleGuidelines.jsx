...
const EditorialArticleGuidelines = () => {
    return (
        <section className="container editorial-article pt-4 px-3 px-md-5">
            <h3 className="fw-semibold mb-3">Editorial Article</h3>
            ...
            <p>
                <strong>Type of Article:</strong> Editorial
            </p>
            <p>
            ...
            <p>
                <strong>Word Limit/Count:</strong> The text should not exceed
                1000 words and should include no more than 15 references.
            </p>
            <p>
                <strong>Editorial:</strong> [Please enter your text here or
                paste the text].
            </p>
            <p>
                <strong>Side headings:</strong> [Optional]
            </p>
            ...
            <p>
                ...
                figures/tables are in parenthesis, e.g. (Figure 1) or (Table 1)]
            </p>
            <p>
...
export default EditorialArticleGuidelines;
